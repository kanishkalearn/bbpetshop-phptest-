...
$petid = $_POST['petid'];
        ...
        if(mysqli_query($conn, $sql1)){
                         ...
                         $sql1 = "delete from grn where petid='$petid' and gstatus=0";
...
if(isset($_POST['btn-sellpet'])){
   ...
   if(!$error){
        ...
        if(mysqli_query($conn, $sql1)){
            ...
            $sql1 = "insert into grn (date,totalvalue,petid,seller_customer_personrid,gstatus) values (now(),".$price.",'$petid',".$personid.",0)";
