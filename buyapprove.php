        ...
        <div class="container">
            ...
            <div class="container-fluid" style="display:flex;flex-wrap:wrap;width:98%;justify-content:center;align:content:space-evenly;">
                ...
                $petsql="select * from pet p inner join breed b on b.breedid=p.breed_breedid
                           ...
                           inner join invoice_buyer i on i.petid=p.petid
                           where sellingstatus=4 && istatus=0" ;
                    ...
                    <center>
                        <form method="POST" action="approving.php">
                            <div>
                                ...
                                <div style="display:flex;width:96%;justify-align:space-evenly;flex-wrap:wrap;flex-direction:rows;" for="petid">
                                    <div style="width:80%;margin-left:4%;display:flex" for="invoice">
                                        <input readonly class="boxinput" type="text" style="width:60%" value="INVOICE ID:">
                                        <input readonly style="width:40%" type="text" class="boxinput" name="invoice" value=<?php echo '"'.$petrow[ 'invoiceid']. '"'; ?>></div>
                                    
                                </div>
                                
                                        
                                        <?php 
                                                 $inid=$petrow[ 'invoiceid'];
                                                 $isql="select * from  seller_customer s 
                                                   inner join invoice_buyer i on i.seller_customer_personrid=s.personrid
                                                   where invoiceid='$inid'" ;
                                                   $iresult=mysqli_query($conn,$isql);
                                                   if($irow=mysqli_fetch_assoc($iresult)){ ?>
                                 <div style="display:flex;width:96%;justify-align:space-evenly;flex-wrap:wrap;flex-direction:rows;" for="buyerid">
                                    <div style="width:80%;margin-left:4%;display:flex" for="buyerid">
                                        <input readonly class="boxinput" type="text" style="width:60%" value="BUYER ID:">
                                        <input readonly style="width:40%" type="text" class="boxinput" name="buyerid" value=<?php echo '"'.$irow['personrid']. '"'; ?>></div>
                                  </div>
                                  <div style="display:flex;width:96%;justify-align:space-evenly;flex-wrap:wrap;flex-direction:rows;" for="buyername">
                                    <div style="width:80%;margin-left:4%;display:flex" for="buyername">
                                        <input readonly class="boxinput" type="text" style="width:60%" value="BUYER ID:">
                                        <input readonly style="width:40%" type="text" class="boxinput" name="buyername" value=<?php echo '"'.$irow['username']. '"'; ?>></div>
                                  </div>
                                        <?php
                                        }
                                        ?>
                                ...
                                <div style="width:90%;justify-align:space-evenly;flex-wrap:wrap;display:flex;flex-direction:row;">
                                    ...
                                    <input style="margin-left:2%;" type="submit" name="bt-approvebuy" class="btn btn-Primary btn-sm" value="Approve">    
                                    <input style="margin-left:2%;" type="submit" name="bt-cancelbuyapprove" class="btn btn-Primary btn-sm" value="Reject"> 
                                </div>
