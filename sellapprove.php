        ...
        <div class="container">
            ...
            <div class="container-fluid" style="display:flex;flex-wrap:wrap;width:98%;justify-content:center;align:content:space-evenly;">
                ...
                $petsql="select * from pet p inner join breed b on b.breedid=p.breed_breedid
                           ...
                           inner join grn g on g.petid=p.petid
                           where sellingstatus=2 and gstatus=0"  ;
                    ...
                    <center>
                        <form method="POST" action="approving.php">
                            <div>
                                ...
                                <div style="display:flex;width:96%;justify-align:space-evenly;flex-wrap:wrap;flex-direction:rows;" for="petid">
                                    <div style="width:60%;margin-left:4%;display:flex" for="grn">
                                        <input readonly class="boxinput" type="text" style="width:30%" value="GRN:">
                                        <input readonly style="width:70%" type="text" class="boxinput" name="grn" value=<?php echo '"'.$petrow[ 'grnid']. '"'; ?>></div>
                                    
                                </div>
                                <?php 
                                                 $gnid=$petrow[ 'grnid'];
                                                 $gsql="select * from  seller_customer s 
                                                   inner join grn g on g.seller_customer_personrid=s.personrid
                                                   where grnid='$gnid'" ;
                                                   $gresult=mysqli_query($conn,$gsql);
                                                   if($grow=mysqli_fetch_assoc($gresult)){ ?>
                                 <div style="display:flex;width:96%;justify-align:space-evenly;flex-wrap:wrap;flex-direction:rows;" for="sellerid">
                                    <div style="width:80%;margin-left:4%;display:flex" for="sellerid">
                                        <input readonly class="boxinput" type="text" style="width:60%" value="SELLER ID:">
                                        <input readonly style="width:40%" type="text" class="boxinput" name="sellerid" value=<?php echo '"'.$grow['personrid']. '"'; ?>></div>
                                  </div>
                                  <div style="display:flex;width:96%;justify-align:space-evenly;flex-wrap:wrap;flex-direction:rows;" for="sellername">
                                    <div style="width:80%;margin-left:4%;display:flex" for="buyername">
                                        <input readonly class="boxinput" type="text" style="width:60%" value="SELLER NAME:">
                                        <input readonly style="width:40%" type="text" class="boxinput" name="sellername" value=<?php echo '"'.$grow['username']. '"'; ?>></div>
                                  </div>
                                        <?php
                                        }
                                        ?>
                                ...
                                <div style="width:90%;justify-align:space-evenly;flex-wrap:wrap;display:flex;flex-direction:row;">
                                    ...
                                    <input style="margin-left:2%;" type="submit" name="bt-approvesell" class="btn btn-Primary btn-sm" value="Approve">   
                                    <input style="margin-left:2%;" type="submit" name="bt-cancelsellapprove" class="btn btn-Primary btn-sm" value="Reject"> 
                                </div>
