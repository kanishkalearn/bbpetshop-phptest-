...
<div style="width:100%;display:flex;flex-direction:row-reverse;">
    ...
    <div class="container-fluid" style="align-content:center;">
        <div class="container">
            ...
            <div class="container-fluid" style="display:flex;flex-wrap:wrap;bwidth:95%;justify-content:center;align:content:space-evenly;">
                <?php include( 'dbcon.php'); $usern=$_SESSION[ 'username']; $petsql="select * from pet p inner join breed b on b.breedid=p.breed_breedid
                           ...
                           where username='$usern'" ; $petresult=mysqli_query($conn,$petsql); while($petrow=mysqli_fetch_assoc($petresult)){ ?>
                <div class="post-box">
                    <center>
                        <form method="POST" action="sell.php">
                            <div>
                                ...
                                <div style="width:90%;justify-align:space-evenly;flex-wrap:wrap;display:flex;flex-direction:row;">
                                    <?php if($petrow[ 'sellingstatus']==1){?>
                                    <input type="submit" name="bt-sell" class="btn btn-Primary btn-sm" value="Sell">
                                    <?php  }else if($petrow[ 'sellingstatus']==2){  ?>
                                    <label style="width:50%;">Pending</label>
                                    <input style="width:40%;" type="submit" name="bt-cancel" class="btn btn-warning btn-sm" value="cancel">
                                    
                                    
                                    <?php }else if($petrow[ 'sellingstatus']==3){ ?>
                                  ...
                                  <input style="margin-left:2%;" type="submit" name="bt-view" class="btn btn-Primary btn-sm" value="View Info">
